...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "http://www.linkedin.com/in/kaveti-eshwar-9732b6266",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@Pranay_kaveti",
    icon: Instagram,
    url: "https://www.instagram.com/pranay_kaveti?igsh=MWl5ZWs5bHB1MGpjbA==",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@Pranay-Kaveti",
    icon: Github,
    url: "https://github.com/Pranay-kaveti",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://x.com/KavetiE90956?t=2zFefNxmRr9CHkE8BoKEJg&s=09",
    color: "#1DA1F2",
