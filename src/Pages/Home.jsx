...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Pranay-kaveti" },
  { icon: Linkedin, link: "http://www.linkedin.com/in/kaveti-eshwar-9732b6266" },
  { icon: Instagram, link: "https://www.instagram.com/pranay_kaveti?utm_source=qr&igsh=MTBrN3l2Nzd0NTZ4bw==" },
];
      ...
      >
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[0%] min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            {/* Left Column */}
           <div
  className="w-full lg:w-1/2 lg:ml-10 xl:ml-[20vh] space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-10 mt-6"
  data-aos="fade-right"
  data-aos-delay="200"
>
